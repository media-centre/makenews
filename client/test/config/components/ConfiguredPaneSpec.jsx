...
describe("ConfiguredPane", () => {
    ...
    describe("display configured sources", () => {
        it("should render twitter sources when the current source tab is TWITTER", () => {
            ...
            const configuredPane = TestUtils.renderIntoDocument(
                <Provider store={store}>
                    <ConfiguredPane/>
                </Provider>
            );
            const configuredSourcesDOM = ReactDOM.findDOMNode(configuredPane);
            const source = configuredSourcesDOM.querySelectorAll(".source-name");
            const sourcesHeading = configuredSourcesDOM.querySelector(".list-sources__group__heading");
