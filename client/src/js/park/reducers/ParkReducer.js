...
import { DISPLAY_PARKED_FEEDS, UNPARK_FEED } from "../actions/ParkActions";
...
export function parkedFeeds(state = { "messages": Locale.applicationStrings().messages.parkPage }, action = {}) {
    ...
    case DISPLAY_PARKED_FEEDS:
        return Object.assign({}, state, {
            ...
            "parkedItems": List(action.parkedItems).toArray()
        });
    case UNPARK_FEED:
        {
            ...
            return Object.assign({}, state, {
                "messages": parkMessages,
                "parkedItems": List(parkedItems.delete(parkedItems.indexOf(action.feed))).toArray()
            });
        }
    default:
        return state;
