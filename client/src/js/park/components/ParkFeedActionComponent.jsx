...
export default class ParkFeedActionComponent extends Component {
    render() {
        return (
            <ul className="feed-actions right clear-fix" onClick={this.props.feedAction}><li className="left" title="Unpark this feed"><i ref="reply" className="fa fa-reply"></i></li></ul>
        );
    }
}
