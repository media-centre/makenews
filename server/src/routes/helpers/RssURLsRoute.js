...
export default class RssFeedsRoute extends Route {
    ...
    handle() {
        ...
        rssRequestHandler.fetchRssFeedRequest(this.url).then(feeds => { //create new function like fetchRSSFetchRequest in RSS Request Handler which calls getURLDocument in couchClient
